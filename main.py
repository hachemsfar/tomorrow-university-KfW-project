...
def recommendations():
    ...
    st.write(data_city[['Ort','population','people/charger','# chargers need to be added']].sort_values(['# chargers need to be added'],ascending=False).reset_index(drop=True))
